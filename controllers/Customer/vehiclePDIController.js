import BookingCounter from "../../models/Customer/BookingCounter.js";
import VehiclePDIRequest from "../../models/Customer/VehiclePDIRequest.js";
...
export const updateRequest = async (req, res) => {
  try {
    ...
    request.transmissionType =
      req.body.transmissionType || request.transmissionType;
